...
public class PostController {
	...
	public String addPost(Model model,@ModelAttribute Publicacion form){	
	...
	public String editPost(Model model,  @ModelAttribute Publicacion form,@PathVariable Long id){	
		...
		if(form.getTitulo() != "")post.setTitulo(form.getTitulo());
		if(form.getContenido() != "")post.setContenido(form.getContenido());
